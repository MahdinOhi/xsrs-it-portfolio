            ...
            <div className={`relative transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              ...
              <div className="relative w-full h-96 lg:h-[500px] flex items-center justify-center">
                ...
                <div className="relative z-10 w-full max-w-md mx-auto">
                  <div className="relative overflow-hidden rounded-2xl bg-black/30 backdrop-blur-sm border border-[#ff6600]/30 p-6">
                    ...
                    <div className="bg-black rounded-lg p-4 border border-[#ff6600]/50 relative overflow-hidden">
                      <div className="text-[#ff6600] font-mono text-xs">
                        ...
                        <div className="text-[#ff6600] mt-1 animate-fade-in-up" style={{animationDelay: '2s'}}>✓ Founded: 2021</div>
                        <div className="text-[#ff6600] mt-1 animate-fade-in-up" style={{animationDelay: '3s'}}>✓ Team: 15+ Experts</div>
                        <div className="text-[#ff6600] mt-1 animate-fade-in-up" style={{animationDelay: '4s'}}>✓ Location: San Francisco</div>
