      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white font-audiowide mb-4">
            Our <span className="text-[#00abf0]">Services</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="group relative bg-black/30 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-[#00abf0]/30 hover:border-[#00abf0]/60 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#00abf0]/20">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-[#00abf0]/10 rounded-full mb-4 border border-[#00abf0]/30 group-hover:bg-[#00abf0]/20 transition-colors duration-300">
                <svg className="w-8 h-8 text-[#00abf0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-300 text-sm font-audiowide leading-relaxed">
